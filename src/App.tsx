...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-md shadow-sm' : 'bg-transparent'}`}>
        <div className="max-w-6xl mx-auto px-6 h-28 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#problema" className="text-sm text-gray-600 hover:text-gray-900 font-medium transition-colors">El Problema</a>
            <a href="#solucion" className="text-sm text-gray-600 hover:text-gray-900 font-medium transition-colors">La Solución</a>
            <a href="https://app.asakaa.com" className="text-sm text-gray-600 hover:text-gray-900 font-medium transition-colors">Iniciar Sesión</a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-md border-t border-gray-100 px-6 py-6 space-y-4 shadow-lg">
            <a href="#problema" className="block py-3 text-gray-700 font-medium hover:text-blue-600 transition-colors">El Problema</a>
            <a href="#solucion" className="block py-3 text-gray-700 font-medium hover:text-blue-600 transition-colors">La Solución</a>
            <a href="https://app.asakaa.com" className="block py-3 text-gray-700 font-medium hover:text-blue-600 transition-colors">Iniciar Sesión</a>
      ...
      <section className="pt-36 pb-24 px-6 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/50 text-emerald-700 px-5 py-2.5 rounded-full text-sm font-semibold mb-8 shadow-sm">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-[1.1] mb-8 tracking-tight">
              ...
              <span className="block bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 bg-clip-text text-transparent">horas no facturadas</span>
            </h1>

            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-12 leading-relaxed">
              Presentamos <strong className="text-gray-900 font-semibold">Asakaa v1.1</strong>. El primer sistema de tiempo diseñado para ingenieros que odian reportar horas y gerentes que aman la rentabilidad.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
              ...
              <a href="#solucion" className="group inline-flex items-center justify-center gap-2 text-gray-600 px-8 py-4 text-lg font-medium hover:text-gray-900 transition-colors">
                Ver cómo funciona
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl shadow-gray-900/10 border border-gray-200/50 overflow-hidden">
                <div className="bg-gradient-to-b from-gray-50 to-gray-100 border-b border-gray-200 px-4 py-3 flex items-center gap-3">
                  ...
                  <div className="flex-1 mx-4">
                    <div className="bg-white rounded-lg px-4 py-2 text-sm text-gray-500 text-center border border-gray-200 shadow-inner flex items-center justify-center gap-2">
                      ...
                      app.asakaa.com/time-intelligence
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-3 gap-6 bg-gradient-to-r from-red-500/10 via-red-500/5 to-red-500/10 border border-red-500/20 rounded-2xl p-10">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <div className="text-slate-400 mt-2">{stat.text}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Solution */}
      <section id="solucion" className="py-28 px-6 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <span className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/50 text-emerald-700 px-5 py-2.5 rounded-full text-sm font-semibold mb-8">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
              La Solución
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Una vista para cada rol.<br />
              <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Inteligencia para todos.</span>
            </h2>
          ...
          <div className="space-y-8">
            {/* Engineer */}
            <div className="group bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500">
              <div className="grid lg:grid-cols-2">
                <div className="p-10 lg:p-14">
                  <span className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold mb-6">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
                    Para el Ingeniero
                  </span>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Execution View</h3>
                  <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                    <strong className="text-gray-900">Reporte en 1 clic. Sin fricción.</strong> El ingeniero ve sus tareas del día y registra tiempo con un solo clic.
                  </p>
            ...
            {/* Tech Lead */}
            <div className="group bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-500">
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-10 lg:p-14 order-1 lg:order-2">
                  ...
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Planning View (Gantt)</h3>
                  <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                    <strong className="text-gray-900">Evita el Burnout. Visualiza la carga real.</strong> Ve quién está sobrecargado antes de que sea tarde.
                  </p>
                  <ul className="space-y-4">
            ...
            {/* Manager */}
            <div className="group bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500">
              <div className="grid lg:grid-cols-2">
                <div className="p-10 lg:p-14">
                  <span className="inline-flex items-center gap-2 bg-emerald-50 text-emerald-700 px-4 py-2 rounded-full text-sm font-semibold mb-6">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Para el Gerente
                  </span>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Financial View</h3>
                  <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                    <strong className="text-gray-900">Auditoría en tiempo real.</strong> Ve la rentabilidad de cada proyecto antes de que sea tarde.
                  </p>
                  <ul className="space-y-4">
